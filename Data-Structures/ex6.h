 ...
 */
PokemonNode *createPokemonNode(const PokemonData *data, int starter);
 ...
 */
OwnerNode *createOwner(PokemonNode *starter);
...
void addToPokdex(PokemonNode **node, int check);
// finding the minimum of a tree
...
// swaping owners places
void swapOwnerNodes(OwnerNode *a, OwnerNode *b);
// sorting owners by nodes
